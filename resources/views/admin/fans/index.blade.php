        ...
        <div class="col-md-8">
            <div class="panel panel-default">
                        ...
                        <div class="pull-right">
                            <div class="form-group">
                                <select name="sort_by" class="form-control input-sm">
                                    <option value="">关注时间</option>
                                    <option value="">活跃度</option>
                                    <option value="">最后发言时间</option>
                                </select>
                            </div>
                            <div class="form-group">
                ...
                <div class="user-list clearfix">
                    @for($i = 0; $i < 50; $i++)
                        <div class="col-md-4 col-sm-6 user-item" data-username="小魔鱼" data-location="北京 海淀" data-remark="小姨子" data-group-id="{{ mt_rand(0,6) }}" data-signature="http://overtrue.me">
                            <div class="media">
...
<div id="user-popover-template" class="hidden">
    <table>
        <tr>
            <td colspan="2"><span class="nickname">小墨鱼 女</span></td>
        </tr>
        <tr>
            <td colspan="2"><span class="remark">我的小妹子</span> <a href="javascript:;"><i class="ion-ios-compose-outline"></i></a></td>
        </tr>

        <tr>
            <td class="popover-table-label">地区：</td>
            <td class="location">北京 海淀</td>
        </tr>
        <tr>
            ...
            <td>
                <select name="group" id="">
                    ...
                    <option value="2" selected>分组2</option>
        ...
        <tr>
            ...
            <td class="signature">http://overtrue.me</td>
        </tr>
    </table>
</div>
@stop
