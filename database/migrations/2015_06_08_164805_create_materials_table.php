...
class CreateMaterialsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('materials', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_multi')->nullable()->default(1)->comment('是否是多图文 1 否 2 是'); 
            $table->tinyInteger('is_remote')->nullable()->default(1)->comment('是否是远程不可编辑图文 1 是 2 否'); 
            ...
            $table->tinyInteger('created_from')->nullable()->default(1)->comment('1 微易同步到微信 2自微信同步微易');
